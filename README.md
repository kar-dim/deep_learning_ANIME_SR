...
| Μοντέλο | Avg PSNR (dB) | Avg SSIM | Παράμετροι | Inference |
|---------|--------------|----------|------------|-----------|
| Bicubic (baseline) |   39.17   |   0.9785   |   -   |            -            |
| SRCNN              |   42.44   |   0.9875   | ~57K  |         ~76 ms          |
| EDSR-Baseline      |   44.37   |   0.9903   | ~1.2M |         ~79 ms          |
| EDSR-Full          | **46.46** | **0.9928** | ~38.4M | ~261 ms (FP16 TensorRT, full image) |

> Όλα τα μοντέλα αξιολογήθηκαν σε 188 anime frames που δεν συμπεριλαμβάνονταν στα δεδομένα εκπαίδευσης.
> PSNR/SSIM υπολογίστηκαν στο κανάλι Y (φωτεινότητα). Inference σε RTX 4070 Super (12 GB).  
